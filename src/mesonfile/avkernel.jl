    ...
    for s=1:length(meshz)
        ...
        for j=1:length(meshk)
            ...
            for m=1:length(meshz)
                ...
                kernel18(y) = D(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*((2*(2*k2*P2*sqrt(P2*q2)*zk^2*zq*(-2*(A2in*B1in + A1in*B2in)*q2 + (A2in*B1in - A1in*B2in)*sqrt(P2*q2)*zq) - 4*sqrt(k2*P2)*zk*(-((A2in*B1in + A1in*B2in)*q2) + (A2in*B1in - A1in*B2in)*sqrt(P2*q2)*zq)*(-(P2*q2) + P2*q2*zq^2) + (-(P2*q2) + P2*q2*zq^2)*(2*(A2in*B1in - A1in*B2in)*P2*q2*zq^2 + k2*((-(A2in*B1in) + A1in*B2in)*P2 + 2*(A2in*B1in + A1in*B2in)*sqrt(P2*q2)*zq) + q2*((-3*A2in*B1in + 3*A1in*B2in)*P2 + 2*(A2in*B1in + A1in*B2in)*sqrt(P2*q2)*zq)) + 2*k2*P2*q2*((A2in*B1in - A1in*B2in)*P2 - 2*(A2in*B1in + A1in*B2in)*sqrt(P2*q2)*zq)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2 + sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))*(-2*(3*(A2in*B1in - A1in*B2in)*P2 - 4*(A2in*B1in + A1in*B2in)*sqrt(P2*q2)*zq)*(P2*q2 - P2*q2*zq^2) + 4*sqrt(k2*P2)*zk*((A2in*B1in + A1in*B2in)*P2*q2*zq^2 + P2*((A2in*B1in + A1in*B2in)*q2 + (-(A2in*B1in) + A1in*B2in)*sqrt(P2*q2)*zq)))))/(9. *P2*(k2 + q2 - 2*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))
                
                kernel21(y) = D(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*((2*k2^2*P2^2*(4*B1in*B2in + A1in*A2in*(P2 - 4*q2))*zk^4 + k2*P2*zk^2*((4*B1in*B2in + A1in*A2in*(P2 + 8*q2))*(P2*q2 + 2*P2*q2*zq^2) - 4*k2*(A1in*A2in*P2^2 + P2*(4*B1in*B2in - 5*A1in*A2in*q2) - 2*A1in*A2in*P2*q2*zq^2) + 4*sqrt(k2)*sqrt(q2)*(A1in*A2in*P2^2 + 4*P2*(B1in*B2in - A1in*A2in*q2) - 8*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) - 16*A1in*A2in*k2*P2*q2*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2) - 4*(k2*P2)^1.5*sqrt(P2*q2)*zk^3*zq*(4*B1in*B2in + A1in*A2in*(P2 - 4*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))) + P2*(2*k2^2*(A1in*A2in*P2^2 + P2*(4*B1in*B2in - 6*A1in*A2in*q2) + 2*A1in*A2in*P2*q2*zq^2) + k2*((4*B1in*B2in + A1in*A2in*(P2 + 8*q2))*(-(P2*q2) + P2*q2*zq^2) - 4*sqrt(k2)*sqrt(q2)*(A1in*A2in*P2^2 + 4*P2*(B1in*B2in - A1in*A2in*q2) + 4*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + 28*A1in*A2in*k2*P2*q2*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2) + 3*k2*P2*q2*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2*(4*B1in*B2in + A1in*A2in*(P2 + 8*q2 - 16*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))))) + 2*P2*sqrt(k2*P2)*sqrt(P2*q2)*zk*zq*(2*k2*(4*B1in*B2in + A1in*A2in*(P2 - 10*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))) + 3*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))*(-4*B1in*B2in + A1in*A2in*(-P2 - 8*q2 + 16*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))))))/(9. *(-(k2*P2) + k2*P2*zk^2)^2*(k2 + q2 - 2*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))
                
                kernel22(y) = D(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*((-4*k2^2*P2^2*(4*B1in*B2in + A1in*A2in*(P2 - 4*q2))*zk^4*(P2*q2 + 2*P2*q2*zq^2) + 2*P2*sqrt(k2*P2)*sqrt(P2*q2)*zk*zq*(3*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))*(-(P2*q2*(28*B1in*B2in + A1in*A2in*(7*P2 + 20*q2))) + 4*P2*q2*(4*B1in*B2in + A1in*A2in*(P2 + 8*q2))*zq^2 + sqrt(k2)*sqrt(q2)*(15*A1in*A2in*P2^2 + 4*P2*(15*B1in*B2in + A1in*A2in*q2) - 64*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))) + k2*((4*B1in*B2in + A1in*A2in*(P2 - 36*q2))*(-(P2*q2) + P2*q2*zq^2) + sqrt(k2)*sqrt(q2)*(-21*A1in*A2in*P2^2 + P2*(-84*B1in*B2in + 4*A1in*A2in*q2) + 80*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))) + P2*(-(k2^2*(-(P2*q2) + P2*q2*zq^2)*(-7*A1in*A2in*P2^2 + 4*P2*(-7*B1in*B2in + 3*A1in*A2in*q2) + 16*A1in*A2in*P2*q2*zq^2)) + 3*k2*P2*q2*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2*(P2*q2*(28*B1in*B2in + A1in*A2in*(7*P2 + 20*q2)) - 4*P2*q2*(4*B1in*B2in + A1in*A2in*(P2 + 8*q2))*zq^2 - 4*sqrt(k2)*sqrt(q2)*(3*A1in*A2in*P2^2 + 4*P2*(3*B1in*B2in + A1in*A2in*q2) - 16*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))) + k2*(-((-(P2*q2) + P2*q2*zq^2)*(-(P2*q2*(28*B1in*B2in + A1in*A2in*(7*P2 + 20*q2))) + 4*P2*q2*(4*B1in*B2in + A1in*A2in*(P2 + 8*q2))*zq^2)) + 8*sqrt(k2)*sqrt(q2)*(-(P2*q2) + P2*q2*zq^2)*(-(A1in*A2in*P2^2) + P2*(-4*B1in*B2in + 4*A1in*A2in*q2) + 8*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + 7*k2*P2*q2*(3*A1in*A2in*P2^2 + 4*P2*(3*B1in*B2in + A1in*A2in*q2) - 16*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2)) + 2*(k2*P2)^1.5*sqrt(P2*q2)*zk^3*zq*(-36*A1in*A2in*P2*q2^2 + 12*sqrt(k2)*P2*(4*B1in*B2in + A1in*A2in*P2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + P2*q2*(4*B1in*B2in + A1in*A2in*(P2 - 16*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))) + 8*P2*q2*zq^2*(4*B1in*B2in + A1in*A2in*(P2 - 4*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))))) + k2*P2*zk^2*(20*A1in*A2in*P2^2*q2^3 - 12*k2*P2^2*(4*B1in*B2in + A1in*A2in*P2)*q2*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2 - 8*P2^2*q2^2*zq^4*(4*B1in*B2in + A1in*A2in*(4*k2 + P2 - 16*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))) + 2*P2^2*q2*zq^2*(5*k2*(4*B1in*B2in + A1in*A2in*P2) + 32*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))*(-4*B1in*B2in + A1in*A2in*(-P2 + sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))))) + P2*q2^2*(8*A1in*A2in*P2*q2*zq^2 + P2*(28*B1in*B2in + A1in*A2in*(-28*k2 + 7*P2 + 32*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))))) + q2*(-64*A1in*A2in*P2^2*q2^2*zq^4 + 2*P2^2*q2*zq^2*(20*B1in*B2in + A1in*A2in*(-12*k2 + 5*P2 + 64*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))) + P2^2*(11*k2*(4*B1in*B2in + A1in*A2in*P2) - 8*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))*(4*B1in*B2in + A1in*A2in*(P2 + 2*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))))))))/(18. *P2*(-(k2*P2) + k2*P2*zk^2)^2*(k2 + q2 - 2*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))
                
                kernel23(y) = D(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*((sqrt(P2*q2)*zq*(2*k2^2*P2^2*sqrt(P2*q2)*(4*B1in*B2in - A1in*A2in*(P2 + 4*q2))*zk^4*zq + k2*P2*sqrt(P2*q2)*zk^2*zq*((4*B1in*B2in - A1in*A2in*(P2 - 8*q2))*(P2*q2 + 2*P2*q2*zq^2) + 2*k2*(A1in*A2in*P2^2 + P2*(-4*B1in*B2in + 6*A1in*A2in*q2) + 4*A1in*A2in*P2*q2*zq^2) - 8*sqrt(k2)*sqrt(q2)*(A1in*A2in*P2^2 + P2*(-4*B1in*B2in + 4*A1in*A2in*q2) + 4*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) - 16*A1in*A2in*k2*P2*q2*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2) + P2*sqrt(k2*P2)*zk*(k2*(-(P2*q2*(-4*B1in*B2in + A1in*A2in*(P2 + 4*q2))) + P2*(4*B1in*B2in - A1in*A2in*(P2 - 12*q2))*q2*zq^2 - 2*sqrt(k2)*sqrt(q2)*(A1in*A2in*P2^2 + P2*(-4*B1in*B2in + 4*A1in*A2in*q2) + 20*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))) + 3*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))*(2*P2*(-4*B1in*B2in + A1in*A2in*(P2 - 8*q2))*q2*zq^2 + sqrt(k2)*sqrt(q2)*(A1in*A2in*P2^2 + P2*(-4*B1in*B2in + 4*A1in*A2in*q2) + 32*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))) + (k2*P2)^1.5*zk^3*(4*A1in*A2in*P2*q2^2 + 2*sqrt(k2)*P2*(-4*B1in*B2in + A1in*A2in*P2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + 4*P2*q2*zq^2*(-4*B1in*B2in + A1in*A2in*(P2 + 4*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))) + P2*q2*(-4*B1in*B2in + A1in*A2in*(P2 + 8*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))))) + P2*sqrt(P2*q2)*zq*(4*A1in*A2in*k2^2*(-(P2*q2) + P2*q2*zq^2) + k2*((4*B1in*B2in - A1in*A2in*(P2 - 8*q2))*(-(P2*q2) + P2*q2*zq^2) + 2*sqrt(k2)*sqrt(q2)*(A1in*A2in*P2^2 + P2*(-4*B1in*B2in + 4*A1in*A2in*q2) - 8*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + 28*A1in*A2in*k2*P2*q2*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2) - 3*k2*P2*q2*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2*(-4*B1in*B2in + A1in*A2in*(P2 - 8*q2 + 16*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))))/(9. *(-(k2*P2) + k2*P2*zk^2)^2*(k2 + q2 - 2*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))
                ...
                kernel61(y) = D(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*((2*((A2in*B1in - A1in*B2in)*(k2*P2)^1.5*zk^3 + k2*P2*zk^2*((A2in*B1in + A1in*B2in)*q2 + (-2*A2in*B1in + 2*A1in*B2in)*sqrt(P2*q2)*zq - 2*(A2in*B1in + A1in*B2in)*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))) + sqrt(k2)*P2*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))*((A2in*B1in + A1in*B2in)*q2 + (-(A2in*B1in) + A1in*B2in)*sqrt(P2*q2)*zq - (A2in*B1in + A1in*B2in)*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))) + k2*(-((A2in*B1in + A1in*B2in)*P2*q2*zq^2) + P2*(-((A2in*B1in + A1in*B2in)*q2) + (A2in*B1in - A1in*B2in)*sqrt(P2*q2)*zq) + (A2in*B1in + A1in*B2in)*sqrt(k2)*P2*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))) + sqrt(k2*P2)*zk*(sqrt(P2*q2)*zq*(-((A2in*B1in + A1in*B2in)*q2) + (A2in*B1in - A1in*B2in)*sqrt(P2*q2)*zq) + k2*((-(A2in*B1in) + A1in*B2in)*P2 + (A2in*B1in + A1in*B2in)*sqrt(P2*q2)*zq) + sqrt(k2)*sqrt(q2)*((A2in*B1in - A1in*B2in)*P2 + 2*(A2in*B1in + A1in*B2in)*sqrt(P2*q2)*zq)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))/(3. *sqrt(k2*P2)*zk*(-(k2*P2) + k2*P2*zk^2)*(k2 + q2 - 2*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))
                
                kernel62(y) = D(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*((k2*(-(P2*q2) + P2*q2*zq^2)*(4*(A2in*B1in + A1in*B2in)*P2*q2*zq^2 + P2*(-2*(A2in*B1in + A1in*B2in)*q2 + (-(A2in*B1in) + A1in*B2in)*sqrt(P2*q2)*zq)) + (k2*P2)^1.5*zk^3*(2*(A2in*B1in - A1in*B2in)*P2*q2*zq^2 + q2*((A2in*B1in - A1in*B2in)*P2 - 6*(A2in*B1in + A1in*B2in)*sqrt(P2*q2)*zq)) - 2*sqrt(k2)*P2*sqrt(q2)*((A2in*B1in + A1in*B2in)*k2 + (A2in*B1in + A1in*B2in)*q2 + (-(A2in*B1in) + A1in*B2in)*sqrt(P2*q2)*zq)*(P2*q2 - P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + k2*P2*q2*(4*(A2in*B1in + A1in*B2in)*P2*q2*zq^2 + P2*(2*(A2in*B1in + A1in*B2in)*q2 + (-3*A2in*B1in + 3*A1in*B2in)*sqrt(P2*q2)*zq))*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2 + k2*P2*zk^2*(-((-2*(A2in*B1in + A1in*B2in)*q2 + (A2in*B1in - A1in*B2in)*sqrt(P2*q2)*zq)*(-(P2*q2) + 4*P2*q2*zq^2)) + sqrt(k2)*sqrt(q2)*(8*(A2in*B1in + A1in*B2in)*P2*q2*zq^2 + P2*(4*(A2in*B1in + A1in*B2in)*q2 + (-6*A2in*B1in + 6*A1in*B2in)*sqrt(P2*q2)*zq))*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))) + sqrt(k2*P2)*zk*((-(P2*q2) + P2*q2*zq^2)*(-2*sqrt(P2*q2)*zq*((A2in*B1in + A1in*B2in)*q2 + (-(A2in*B1in) + A1in*B2in)*sqrt(P2*q2)*zq) + k2*((A2in*B1in - A1in*B2in)*P2 - 4*(A2in*B1in + A1in*B2in)*sqrt(P2*q2)*zq)) + 2*sqrt(k2)*sqrt(q2)*((-(A2in*B1in) + A1in*B2in)*P2^2*q2 - 4*(A2in*B1in + A1in*B2in)*(P2*q2)^1.5*zq^3 - 2*P2*sqrt(P2*q2)*zq*((A2in*B1in + A1in*B2in)*q2 + (-2*A2in*B1in + 2*A1in*B2in)*sqrt(P2*q2)*zq))*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + 3*k2*P2*q2*((A2in*B1in - A1in*B2in)*P2 - 2*(A2in*B1in + A1in*B2in)*sqrt(P2*q2)*zq)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2))/(3. *P2*sqrt(k2*P2)*zk*(-(k2*P2) + k2*P2*zk^2)*(k2 + q2 - 2*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))
                ...
                kernel76(y) = D(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*(-0.3333333333333333*(sqrt(P2*q2)*zq*(2*k2^2*P2^2*(4*B1in*B2in - A1in*A2in*P2)*sqrt(P2*q2)*zk^4*zq + k2*P2*sqrt(P2*q2)*zk^2*zq*(2*k2*P2*(-4*B1in*B2in + A1in*A2in*(P2 - 2*q2)) + (4*B1in*B2in - A1in*A2in*P2)*(-(P2*q2) + 2*P2*q2*zq^2) - 4*sqrt(k2)*P2*(-4*B1in*B2in + A1in*A2in*P2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) - 8*A1in*A2in*k2*P2*q2*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2) + P2*sqrt(k2*P2)*zk*(sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))*(2*P2*(-4*B1in*B2in + A1in*A2in*P2)*q2*zq^2 + sqrt(k2)*P2*sqrt(q2)*(-4*B1in*B2in + A1in*A2in*(P2 + 4*q2))*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))) + k2*(P2*q2*(-4*B1in*B2in + A1in*A2in*(P2 + 4*q2)) + P2*q2*(12*B1in*B2in + A1in*A2in*(-3*P2 + 4*q2))*zq^2 + sqrt(k2)*sqrt(q2)*(-2*A1in*A2in*P2^2 + 8*P2*(B1in*B2in - A1in*A2in*q2) + 8*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))) + P2*sqrt(P2*q2)*zq*(-4*A1in*A2in*k2^2*(-(P2*q2) + P2*q2*zq^2) + k2*P2*(4*B1in*B2in - A1in*A2in*P2)*q2*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2 + k2*((4*B1in*B2in - A1in*A2in*P2)*(P2*q2 - P2*q2*zq^2) + 2*sqrt(k2)*P2*(-4*B1in*B2in + A1in*A2in*(P2 - 4*q2))*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + 4*A1in*A2in*k2*P2*q2*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2)) + (k2*P2)^1.5*zk^3*(-4*A1in*A2in*P2*q2^2 - 2*(4*B1in*B2in - A1in*A2in*P2)*(2*P2*q2*zq^2 + sqrt(k2)*P2*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))) + P2*q2*(4*B1in*B2in + A1in*A2in*(-P2 + 8*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))))/(P2*(-(k2*P2) + k2*P2*zk^2)^2*(k2 + q2 - 2*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))
                
                kernel77(y) = D(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*((k2^2*P2^2*zk^4*(2*P2*q2*(4*B1in*B2in + A1in*A2in*(P2 + 4*q2)) - 4*P2*(4*B1in*B2in + A1in*A2in*P2)*q2*zq^2) - k2*P2*zk^2*((-(P2*q2) + 2*P2*q2*zq^2)*(-(P2*q2*(4*B1in*B2in + A1in*A2in*(P2 + 4*q2))) + 2*P2*(4*B1in*B2in + A1in*A2in*P2)*q2*zq^2) + k2*P2*(3*P2*q2*(4*B1in*B2in + A1in*A2in*(P2 + 4*q2)) - 4*P2*q2*(4*B1in*B2in + A1in*A2in*(P2 + 2*q2))*zq^2) - 4*sqrt(k2)*P2*sqrt(q2)*(P2*q2*(4*B1in*B2in + A1in*A2in*(P2 + 4*q2)) - 2*P2*(4*B1in*B2in + A1in*A2in*P2)*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + 2*k2*P2*q2*(A1in*A2in*P2^2 + 4*P2*(B1in*B2in + A1in*A2in*q2) - 8*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2) + P2*(k2^2*(P2*q2 - P2*q2*zq^2)*(A1in*A2in*P2^2 + 4*P2*(B1in*B2in + A1in*A2in*q2) - 8*A1in*A2in*P2*q2*zq^2) + k2*P2*q2*(P2*q2*(4*B1in*B2in + A1in*A2in*(P2 + 4*q2)) - 2*P2*(4*B1in*B2in + A1in*A2in*P2)*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2 + k2*((-(P2*q2) + P2*q2*zq^2)*(-(P2*q2*(4*B1in*B2in + A1in*A2in*(P2 + 4*q2))) + 2*P2*(4*B1in*B2in + A1in*A2in*P2)*q2*zq^2) - 4*sqrt(k2)*P2*sqrt(q2)*(4*B1in*B2in + A1in*A2in*(P2 + 4*q2))*(P2*q2 - P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + k2*P2*q2*(A1in*A2in*P2^2 + 4*P2*(B1in*B2in + A1in*A2in*q2) - 8*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2)) + 2*(k2*P2)^1.5*sqrt(P2*q2)*zk^3*zq*(-4*A1in*A2in*P2*q2^2 + 2*(4*B1in*B2in + A1in*A2in*P2)*(2*P2*q2*zq^2 + sqrt(k2)*P2*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))) - P2*q2*(12*B1in*B2in + A1in*A2in*(3*P2 + 8*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))))) - 2*P2*sqrt(k2*P2)*sqrt(P2*q2)*zk*zq*(k2*((12*B1in*B2in + A1in*A2in*(3*P2 + 4*q2))*(-(P2*q2) + P2*q2*zq^2) + sqrt(k2)*sqrt(q2)*(A1in*A2in*P2^2 + 4*P2*(B1in*B2in - 3*A1in*A2in*q2) + 8*A1in*A2in*P2*q2*zq^2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))) + sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))*(4*A1in*A2in*P2*q2^2 - (4*B1in*B2in + A1in*A2in*P2)*(2*P2*q2*zq^2 + sqrt(k2)*P2*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))) + P2*q2*(4*B1in*B2in + A1in*A2in*(P2 + 4*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))))/(6. *P2*(-(k2*P2) + k2*P2*zk^2)^2*(k2 + q2 - 2*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))
                ...
                kernel87(y) = D(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*((2*(-4*A1in*A2in*P2*q2^2 - 2*(4*B1in*B2in + A1in*A2in*P2)*sqrt(P2*q2)*zq*(sqrt(k2*P2)*zk - sqrt(P2*q2)*zq) - q2*(4*B1in*B2in*P2 + A1in*A2in*P2^2 - 8*A1in*A2in*sqrt(k2*P2)*sqrt(P2*q2)*zk*zq) + k2*(A1in*A2in*P2^2 + 4*P2*(B1in*B2in + A1in*A2in*q2) - 8*A1in*A2in*P2*q2*zq^2))*(k2*P2*q2*zk^2 + k2*(-(P2*q2) + P2*q2*zq^2) - 2*sqrt(k2)*sqrt(k2*P2)*sqrt(q2)*sqrt(P2*q2)*zk*zq*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + k2*P2*q2*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2))^2))/(3. *(-(k2*P2) + k2*P2*zk^2)^2*(k2 + q2 - 2*sqrt(k2)*sqrt(q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))))
    ...
    for s = 1:length(meshz)
        ...
        for j = 1:length(meshk)
            ...
            for m = 1:length(meshz)
                ...
                kernel71(y) = D_infrared(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*((-8*A2in*B1in*(P2 - 2*sqrt(P2*q2)*zq) + 8*A1in*B2in*(P2 + 2*sqrt(P2*q2)*zq))/(9. *k2*P2*(-1 + zk^2)))
                
                kernel72(y) = D_infrared(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*((-4*(-6*A2in*B1in*sqrt(k2*P2)*sqrt(q2)*zk*zq*(sqrt(P2*q2) - 2*q2*zq)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + 6*A1in*B2in*sqrt(k2*P2)*sqrt(q2)*zk*zq*(sqrt(P2*q2) + 2*q2*zq)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + A2in*B1in*sqrt(k2)*q2*(P2 - 2*sqrt(P2*q2)*zq)*(-1 + zq^2 + 6*y*zk*sqrt(1 - zk^2)*zq*sqrt(1 - zq^2) + 3*y^2*(-1 + zk^2)*(-1 + zq^2) + zk^2*(1 + 5*zq^2)) - A1in*B2in*sqrt(k2)*q2*(P2 + 2*sqrt(P2*q2)*zq)*(-1 + zq^2 + 6*y*zk*sqrt(1 - zk^2)*zq*sqrt(1 - zq^2) + 3*y^2*(-1 + zk^2)*(-1 + zq^2) + zk^2*(1 + 5*zq^2))))/(9. *k2^1.5*P2*(-1 + zk^2)^2))
                ...
                kernel76(y) = D_infrared(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*((32*A1in*A2in*q2^1.5*zq^2*(-2*sqrt(k2*P2)*sqrt(P2*q2)*zk*zq*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + sqrt(k2)*P2*sqrt(q2)*(1 - zk^2 + (-1 + 3*zk^2)*zq^2 + 2*y*zk*sqrt(1 - zk^2)*zq*sqrt(1 - zq^2) + y^2*(-1 + zk^2)*(-1 + zq^2))))/(9. *k2^1.5*P2*(-1 + zk^2)^2))
                ...
                kernel82(y) = D_infrared(k2+q2-2*sqrt(k2*q2)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)))*((16*(-6*A2in*B1in*sqrt(k2*P2)*sqrt(q2)*zk*zq*(sqrt(P2*q2) - 2*q2*zq)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + 6*A1in*B2in*sqrt(k2*P2)*sqrt(q2)*zk*zq*(sqrt(P2*q2) + 2*q2*zq)*(zk*zq + y*sqrt(1 - zk^2)*sqrt(1 - zq^2)) + A2in*B1in*sqrt(k2)*q2*(P2 - 2*sqrt(P2*q2)*zq)*(-1 + zq^2 + 6*y*zk*sqrt(1 - zk^2)*zq*sqrt(1 - zq^2) + 3*y^2*(-1 + zk^2)*(-1 + zq^2) + zk^2*(1 + 5*zq^2)) - A1in*B2in*sqrt(k2)*q2*(P2 + 2*sqrt(P2*q2)*zq)*(-1 + zq^2 + 6*y*zk*sqrt(1 - zk^2)*zq*sqrt(1 - zq^2) + 3*y^2*(-1 + zk^2)*(-1 + zq^2) + zk^2*(1 + 5*zq^2))))/(9. *k2^1.5*P2*(-1 + zk^2)^2))
